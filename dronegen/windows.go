	...
	p.Steps = []step{
		{
			...
			Commands: []string{
				...
				`Invoke-WebRequest "https://api.github.com/meta" -UseBasicParsing | ConvertFrom-JSON | Select-Object "ssh_keys" | ForEach-Object { "github.com $_"} | Out-File -Encoding ASCII "$SSHDir\known_hosts"`,
